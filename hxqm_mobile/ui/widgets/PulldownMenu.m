...
- (id)init
{
    ...
    cellFont = [UIFont fontWithName:@"GillSans-Bold" size:17.0f];
...
- (void)loadMenu
{
    ...
    [handle setBackgroundColor:[UIColor whiteColor]];
    ...
    [UIView animateWithDuration: animationDuration
                     ...
                     animations:^{
                         if (fullyOpen)
                         {
                             ...
                             self.center = CGPointMake(self.frame.size.width , -((self.frame.size.height / 2) + topMargin));
                             fullyOpen = NO;
                         }
                         else
                         {
